...
- 프로젝트 방향: 문화행사를 여행의 기준점으로 삼아 주변 맛집을 묶어 일정으로 제안
- 현재 단계: **프론트엔드·백엔드 초기 실행 환경 구성** (DB는 폴더 구조와 문서만 존재)
...
프론트엔드에는 React/Vite 초기 실행 코드가 있습니다. 백엔드와 데이터베이스는 폴더 구조와 문서가 준비되어 있습니다.
...
프론트엔드와 백엔드 초기 설정은 이미 구성되어 있습니다. 새 프로젝트를 생성하지 말고, 각 디렉터리의 실행 안내를 따라 의존성을 설치합니다.

- 백엔드: [`backend/README.md`](backend/README.md) 의 "실행 방법" 항목
- 프론트: [`frontend/README.md`](frontend/README.md) 의 "프로젝트 초기 설정 및 실행" 항목
